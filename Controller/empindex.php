...
<html>
    ...
    <body>
        ...
        <div class = "sidenav">
            <a href = "">Home</a>
            <hr>
            <a href = "http://localhost/bakery/menuindex.php">Daily Menu</a>
            <hr>
            <a href = "">Todays Orders</a>
            <hr>
            <a href = "">Delivery Executives</a>
            <hr>
            <a href = "http://localhost/bakery/empindex.php" class = "active">Employees</a>
            <hr>
            <a href = "">Expenses</a>
            <hr>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="empcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Employee</a>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="empread.php?id='. $row['empid'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><button type = "button">View</button></a>';
                                            echo '<a href="empupdate.php?id='. $row['empid'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><button type = "button">Update</button></a>';
                                            echo '<a href="empdelete.php?id='. $row['empid'] .'" title="Delete Record" data-toggle="tooltip"><button type = "button">Delete</button></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
